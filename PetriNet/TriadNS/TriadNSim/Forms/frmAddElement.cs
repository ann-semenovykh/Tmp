...
namespace TriadNSim.Forms
{
    public partial class frmAddElement : Form
    {
        ...
        public frmAddElement()
        {
            ...
            ontologyManager = frmMainPetri.Instance.OntologyManager;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (sName.Length == 0 || frmMainPetri.Instance.ContainsElement(sName))
            {
        ...
        {
            Bmp = frmMainPetri.LoadImage("Изображение элемента");
        }
