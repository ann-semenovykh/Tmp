    ...
    public partial class frmIConditions : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (frmSimCond.Successed)
            {
                ...
                frmMainPetri.Instance.simConditions.Add(simCond);
                frmMainPetri.Instance.SaveSimConditions();
            }
        }
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            SimCondition EditSimCond = frmMainPetri.Instance.GetSimCondition(sName);
        ...
        {
            int nIndex = listViewIC.SelectedItems[0].Index;
            frmMainPetri.Instance.DeleteSimCondition(listViewIC.SelectedItems[0].Text);
