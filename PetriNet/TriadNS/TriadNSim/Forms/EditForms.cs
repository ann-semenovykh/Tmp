...
namespace TriadNSim.Forms
{
    ...
    public class frmEditIP : frmEditBase
    {
        ...
        protected override bool OnOk()
        {
            ...
            bool bFind = false;
            foreach (InfProcedure proc in frmMainPetri.Instance.userIProcedures)
            {
    ...
    public class frmChangeRoutine : frmEditBase
    {
        ...
        public void SetObject(NetworkObject obj)
        {
            ...
            this.Poluses = obj.Routine.Poluses;
            this.Parameters = obj.Routine.Parameters;
            this.Variables = obj.Routine.Variables;
        ...
        protected override bool OnOk()
        {
            ...
            //    if (networkObj != null && (networkObj.Type != ENetPetriObjectType.UserObject || networkObj == obj))
            //        continue;
    ...
    public class frmChangeSimCondition : frmEditBase
    {
        ...
        {
            bool bFind = false;
            foreach (SimCondition simCond in frmMainPetri.Instance.simConditions)
            {
        ...
        public static bool CompileTo(string sCode, string sFileName, IOErrorListener io = null)
        {
            ...
            {
                //рутины
                COWLOntologyManager manager = frmMainPetri.Instance.OntologyManager;
                ...
                //IP
                foreach (InfProcedure iprocedure in frmMainPetri.Instance.userIProcedures)
                {
