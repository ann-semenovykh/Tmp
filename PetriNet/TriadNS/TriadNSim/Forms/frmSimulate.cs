...
namespace TriadNSim.Forms
{
    public partial class frmSimulate : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            {
                COWLOntologyManager ontologyManager = frmMainPetri.Instance.OntologyManager;
                ...
                {
                    SimCondition simCond = frmMainPetri.Instance.simConditions[index];
                    ...
                    Assembly ass = frmMainPetri.GenerateAssemblyFromFile(sPath, references.ToArray());
        ...
        {
            foreach (var simCond in frmMainPetri.Instance.simConditions)
            {
