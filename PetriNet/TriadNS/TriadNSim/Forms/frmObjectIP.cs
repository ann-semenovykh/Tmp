...
namespace TriadNSim.Forms
{
    public partial class frmObjectIP : Form
    {
        ...
        private InfProcedure GetSelectedIP()
        {
            ...
            return cmbIPType.SelectedIndex == 0 ? frmMainPetri.Instance.standartIProcedures[cmbIP.SelectedIndex] :
                                                    frmMainPetri.Instance.userIProcedures[cmbIP.SelectedIndex];
        }
