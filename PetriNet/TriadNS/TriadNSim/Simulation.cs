...
namespace TriadNSim
{
    ...
    public class Simulation
    {
        ...
        public static Simulation Instance
        {
            ...
            {
                if (_inst == null)
                    _inst = new Simulation(frmMainPetri.Instance, frmMainPetri.Instance.Panel);
                return _inst;
            }
        }
        private Simulation(frmMainPetri mainForm, DrawingPanel.DrawingPanel panel)
        {
        ...
        public bool CreateModel(bool bSimulate)
        {
            ...
            List<PetriLink> links = new List<PetriLink>();
