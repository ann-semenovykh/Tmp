...
namespace DrawingPanel
{
    ...
    public delegate void BeforeAddMark(object sender, BeforeAddMarkEventArgs e);
    ...
    public class BeforeAddMarkEventArgs : EventArgs
    {
        public CConnectionPoint CP;
        public bool cancel;
        public BeforeAddMarkEventArgs(CConnectionPoint cp)
        {
            this.CP = cp;
            this.cancel = false;
        }
    ...
    {
        public PetriLine line;
        public bool fromChanged;

        public OnLineCPChangedEventArgs(PetriLine line, bool bFromChanged)
        {
            this.line = line;
    ...
    public class AbSel : BaseObject
    {
        ...
        public override void Draw(Graphics g, int dx, int dy, float zoom)
        {
            ...
            System.Drawing.Pen myPen = new System.Drawing.Pen(System.Drawing.Color.Blue, 4f);
    ...
    public class Shapes
    {
        ...
        public void DeleteSelected()
        {
            ...
            foreach (BaseObject tmpElem in tmpList)
            {
                ...
                tmpElem.bSelected = false;
                tmpElem.Delete();
                storeDo(UndoRedoAction.uraDelete, tmpElem);
            }

        }
        public PetriMark GetMark(BaseObject obj)
        {
            PetriMark Finded = null;
            foreach (BaseObject o in ShapeList)
            {
                if (o is PetriMark)
                {
                    PetriMark mark = o as PetriMark;
        ...
        public PetriLine GetLine(BaseObject obj1, BaseObject obj2)
        {
            PetriLine FindedLine = null;
            foreach (BaseObject obj in ShapeList)
            {
                if (obj is PetriLine)
                {
                    PetriLine line = obj as PetriLine;
        ...
        public void addMark(CConnectionPoint cp, Color penC, float penW, int x, int y)
        {
            this.deSelect();
            PetriMark r= new PetriMark(drawingPanel, cp);
            r.penColor = penC;
            r.penWidth = penW;
        ...
        public void addConnector(CConnectionPoint From, CConnectionPoint To, Color penC, float penW,int x,int y,int x1,int y1)
        {
            this.deSelect();
            PetriLine r = new PetriLine(drawingPanel, From, To,x,y,x1,y1);
