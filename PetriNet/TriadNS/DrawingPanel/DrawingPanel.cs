...
namespace DrawingPanel
{
    ...
    public partial class DrawingPanel :  UserControl
    {
        ...
        public event BeforeAddMark beforeAddMark;
        ...
        public void redraw(bool All)
        {
            ...
            {
                System.Drawing.Pen myPen = new System.Drawing.Pen(System.Drawing.Color.Red, 4f);
            ...
            if (this.A4)
            {
                System.Drawing.Pen myPen = new System.Drawing.Pen(System.Drawing.Color.Blue, 3.5f);
                myPen.DashStyle = System.Drawing.Drawing2D.DashStyle.Dash;
                myPen.EndCap = LineCap.ArrowAnchor;
                ...
                switch (CurrentTool)
                {
                    case ToolType.ttSelect:
                        if (this.InteractionType != InteractionType.itNone)
                        {
                            ...
                            if (CurrentCP != null && _shapes.selectedObj is PetriLine)
                            {
                                PetriLine connector = _shapes.selectedObj as PetriLine;
        ...
        private void DrawingPanel_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            #region left up
            {
                ...
                switch (CurrentTool)
                {
                        ...
                        if (this.CurrentStatus == DrawingStatus.dsDrawRect)
                        {
                            CConnectionPoint ToCP = _shapes.GetConnectionPoint((int)(e.X / Zoom) - this.dx, (int)(e.Y / Zoom - this.dy));
                                ...
                                if (ToCP != null && ToCP != FromCP )///////////////////
                                {
                                    ...
                                    if (!args.cancel)
                                        this._shapes.addConnector(FromCP, ToCP, CreationPenColor, CreationPenWidth,x,y,x1,y1);
                                }
                    ...
                    case ToolType.ttMark:
                        if (this.CurrentStatus == DrawingStatus.dsDrawRect)
                        {
                            ...
                            if (cp != null)
                            {
                                BeforeAddMarkEventArgs args = new BeforeAddMarkEventArgs(cp);
                                beforeAddMark(this, args);
                                if (!args.cancel)
                                {
                                    this._shapes.addMark(cp, CreationPenColor, CreationPenWidth, (cp.getX1() - cp.getX()) / 2, (cp.getY1() - cp.getY()) / 2);
                                }
                            }
                ...
                if (_shapes.selectedObj != null)
                {
                    ...
                    if (_shapes.selectedObj is PetriLine)
                    {
                        PetriLine connector = _shapes.selectedObj as PetriLine;
                        CConnectionPoint CP = _shapes.GetConnectionPoint((int)(e.X / Zoom) - this.dx, (int)(e.Y / Zoom - this.dy));
                        if (CP == null && hoverShape != null)
