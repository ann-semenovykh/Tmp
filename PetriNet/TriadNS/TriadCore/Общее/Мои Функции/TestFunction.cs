...
namespace TriadCore
{
    ...
    public static class TestFunction
    {
        ...
        public static void TestNodeDegree()
        {
            ...
            g.AddEdge(d1, p1, d2, p2, true);
            g.AddEdge(d1, p4, d3, p3, true);
        ...
        public static void TestMaxMatching()
        {
            ...
            g.AddEdge(node1, polus1, node6, polus1, true);
            g.AddEdge(node2, polus1, node5, polus1, true);
            g.AddEdge(node3, polus1, node8, polus1, true);
            g.AddEdge(node4, polus1, node5, polus1, true);
            g.AddEdge(node4, polus1, node6, polus1, true);
            g.AddEdge(node4, polus1, node7, polus1, true);
            g.AddEdge(node4, polus1, node8, polus1, true);
            int[] p = new int[4];
            ...
            g2.AddEdge(node1, polus1, node4, polus1, true);
            g2.AddEdge(node1, polus1, node5, polus1, true);
            g2.AddEdge(node1, polus1, node6, polus1, true);
            g2.AddEdge(node2, polus1, node4, polus1, true);
            g2.AddEdge(node2, polus1, node7, polus1, true);
            g2.AddEdge(node3, polus1, node7, polus1, true);
            int[] p1 = new int[3];
        ...
        private static void TestAssignProblem()
        {
            ...
            G.AddEdge(n1, polus, n3, polus, true);
            G.AddEdge(n2, polus, n3, polus, true);
            G.AddEdge(n1, polus, n4, polus, true);
            G.AddEdge(n2, polus, n4, polus, true);
        ...
        private static void TestScc()
        {
            ...
            g.AddArc(n2, polus1, n4, polus1);
            g.AddEdge(n4, polus1, n5, polus1, true);
