...
namespace TriadRunner
    {
        ...
        public class M : GraphBuilder
        {
            ...
            public override Graph Build()
            {
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout"), new CoreName("Pol", 0), new CoreName("Rout2"), new CoreName("Pol", 0), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout2"), new CoreName("Pol", 1), new CoreName("Rout3"), new CoreName("Pol", 0), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout3"), new CoreName("Pol", 1), new CoreName("Rout4"), new CoreName("Pol", 0), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                M = this.PopGraph();
                this.PushGraph(M);
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout4"), new CoreName("Pol", 1), new CoreName("Rout5"), new CoreName("Pol", 0), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout5"), new CoreName("Pol", 1), new CoreName("Rout"), new CoreName("Pol", 1), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                M = this.PopGraph();
                this.PushGraph(M);
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout"), new CoreName("Pol", 2), new CoreName("HostA"), new CoreName("Pol"), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout2"), new CoreName("Pol", 2), new CoreName("HostB"), new CoreName("Pol"), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout3"), new CoreName("Pol", 2), new CoreName("HostC"), new CoreName("Pol"), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                M = this.PopGraph();
                this.PushGraph(M);
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout"), new CoreName("Pol", 3), new CoreName("HostD"), new CoreName("Pol"), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout"), new CoreName("Pol", 4), new CoreName("HostE"), new CoreName("Pol"), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout3"), new CoreName("Pol", 3), new CoreName("HostF"), new CoreName("Pol"), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                this.PushEmptyGraph();
                ...
                this.FirstInStackGraph.AddEdge(new CoreName("Rout3"), new CoreName("Pol", 4), new CoreName("HostG"), new CoreName("Pol"), true);
                this.SecondInStackGraph.Add(this.FirstInStackGraph);
                this.PopGraph();
                M = this.PopGraph();
                Routine r;
