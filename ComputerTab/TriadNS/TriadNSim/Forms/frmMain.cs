...
namespace TriadNSim.Forms
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            listView1.Items[0].Tag =new object[2] { "Workstation", ModelObjectType.Client };
            listView1.Items[1].Tag = new object[2] { "Server", ModelObjectType.Server };
            listView1.Items[2].Tag = new object[2] { "Router", ModelObjectType.Undefined };

            listView1.Items[3].Tag = new object[2] { "UserObj", ModelObjectType.UserObject };
        }
        ...
        {
            NetworkObject node=(NetworkObject)FindNode(e.CurNode);
